        ...
        repos.forEach((repo) => {
            ...
            <div class="border p-3 mb-4">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <span class="badge bg-primary mx-2">Star : ${repo.stargazers_count}</span>
                        <span class="badge bg-secondary mx-2">Watchers : ${repo.watchers_count}</span>
                        <span class="badge bg-success mx-2">Forks : ${repo.forks_count}</span>
                    </div>
                </div>
            </div>
            `
